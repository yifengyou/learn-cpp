// Exercise 20.2.
// This exercise mdifies the sample application by accepting the use of a minus
// sign (-) to specify negative numbers. This is done by adding "-?" before the
// numeric pattern.
...
int main() {
     ...
     // ONLY THE FOLLOWING LINE IS MODIFIED, TO INCLUDE AN *OPTIONAL*
     // LEADING MINUS SIGN (-).
